...
async def get_thumb(videoid):
    ...
    try:
        ...
        try:
            font_title = ImageFont.truetype("KanhaMusic/assets/font.ttf", 45)
            font_details = ImageFont.truetype("KanhaMusic/assets/font2.ttf", 30)
            font_watermark = ImageFont.truetype("KanhaMusic/assets/font2.ttf", 25)
        except:
